...
DECLARE_CONFIG_VALUE(NETWORK_PRIORITY_BACKGROUND);
DECLARE_CONFIG_VALUE(NETWORK_PRIORITY_LOWEST);
DECLARE_CONFIG_VALUE(NETWORK_PRIORITY_BELOW_NORMAL);
DECLARE_CONFIG_VALUE(NETWORK_PRIORITY_NORMAL);
DECLARE_CONFIG_VALUE(NETWORK_PRIORITY_ABOVE_NORMAL);
DECLARE_CONFIG_VALUE(NETWORK_PRIORITY_HIGHEST);
DECLARE_CONFIG_VALUE(NETWORK_PRIORITY_TIME_CRITICAL);
